...
from lib import pd, plt, plot, plot_with_std
...
def run():
    ...
    # Remove the invalid values, then convert all the profit values into numeric
    # for plotting
    ...
    plot(
        ...
        y1,
        ax,
        "Increase in mean Fortune 500 company profits from \
        1955 to 2005",
        "Profit (millions)",
    )
    ...
    plot(
        ...
        y2,
        ax,
        "Increase in mean Fortune 500 company revenues from \
        1955 to 2005",
        "Revenue (millions)",
    )
